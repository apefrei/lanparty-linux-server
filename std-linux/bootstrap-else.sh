...
wget https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm -O $TEMPDIR/epel-release-latest-7.noarch.rpm >> $LOGFILE 2>&1
rpm -ivh $TEMPDIR/epel-release-latest-7.noarch.rpm >> $LOGFILE 2>&1
rm $TEMPDIR/epel-release-latest-7.noarch.rpm >> $LOGFILE 2>&1
